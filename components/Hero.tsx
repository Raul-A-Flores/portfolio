        ...
        <div className='flex justify-center relative my-20 z-10'>
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                ...
                <TextGenerateEffect
                    ...
                    words='Transforming Concepts into Seamlesss Experiences' />
                
                <p className='text-center tracking-wider text-sm md:text-g lg:text-2xl mb-4'> Hi, I&apos;m Raul, a Next.js Developer</p>
                <a href='#about'>
                    <MagicButton 
                        title='Show my Work'
